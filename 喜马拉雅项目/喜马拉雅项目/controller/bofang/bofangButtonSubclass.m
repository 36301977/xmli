...
//        self.timer = [NSTimer scheduledTimerWithTimeInterval:2 target:self selector:@selector(pictureAction) userInfo:nil repeats:YES];
    }
...
//- (void)pictureAction{
//    .transform = CGAffineTransformRotate(self.img4Pic.transform,M_PI / 180);
//}
